  ...
  return (
    ...
    <div className="bottom-editable-sect-content">
      ...
      <div className="accessories-headline">
        <i className={`bi bi-card-heading ${editStatueAccessoryActive ? "besc-blue" : ""}`}></i>
          <input
            type="text"
            name="headline"
      ...
      <div className="accessories-birthday">
        <i className={`bi bi-calendar-event ${editStatueAccessoryActive ? "besc-purple" : ""}`}></i>
        <DatePicker
          id="theDatePicker"
      ...
      <div className="accessories-location">
        <i className={`bi bi-geo-alt  ${editStatueAccessoryActive ? "besc-green" : ""}`}></i>
          <input
            type="text"
            name="location"
      ...
      <div className="accessories-company">
        <i className={`bi bi-building  ${editStatueAccessoryActive ? "besc-orange" : ""}`}></i>
          <input
            type="text"
            name="company"
            placeholder="Company"
      ...
      <div className="accessories-relationship">
          <i className={`bi bi-heart-fill  ${editStatueAccessoryActive ? "besc-red" : ""}`}></i>
